...
public class ExpandableListAdapterPencarian extends BaseExpandableListAdapter {
	private Context context;
    private List<Barang> daftarBarang; 
    private MuseumManager mm;
 
    public ExpandableListAdapterPencarian(Context context, List<Barang> daftarBarang) {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        Museum museum = mm.getMuseum(barang.getIdMuseum());
        Ruangan ruangan = museum.getRuangan(barang.getIdRuangan());
        ...
        String infoTambahan = ". Tersedia di " + museum.getNama() + ", ruang " + ruangan.getNama() + ".";
        
        textView.setText(barang.getDeksipsi().concat(infoTambahan));
        return convertView;
    }
